            ...
            try
            {
                ...
                foreach (DataRow employee in tbEmployee.Rows)
                {
                    var empObj = new Employee
                    {
                        ...
                        Phone = Convert.ToInt64(employee["Phone"]),
        ...
        public JsonResult Details(int id)
        {
            ...
            try
            {
                ...
                empObj = new Employee()
                {
                    ...
                    EmployeeId = Convert.ToInt32(tbEmployee.Rows[0].ItemArray[1].ToString()),
                    ...
                    Phone = Convert.ToInt64(tbEmployee.Rows[0].ItemArray[7].ToString()),
